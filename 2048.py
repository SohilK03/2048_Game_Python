        ...
        if key in self.commands:
            ...
            if changed:
                ...
                if logics.get_current_state(self.matrix)=='WON':
                    self.grid_cells[1][1].congifure(text='YOU',bg=c.BACKGROUND_COLOR_CELL_EMPTY)
                    self.grid_cells[1][2].congifure(text='WIN',bg=c.BACKGROUND_COLOR_CELL_EMPTY)
                if logics.get_current_state(self.matrix)=='LOST':
                    self.grid_cells[1][1].congifure(text='YOU',bg=c.BACKGROUND_COLOR_CELL_EMPTY)
                    self.grid_cells[1][2].congifure(text='LOSE',bg=c.BACKGROUND_COLOR_CELL_EMPTY)
